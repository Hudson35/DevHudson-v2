    ...
    <div className="mt-12 bg-black-100 rounded-[20px]">
      <div className={`bg-tertiary rounded-2xl sm:px-16 px-6 sm:py-16 py-10 min-h-[300px]`}>
        <motion.div variants={textVariant()}>
          <p className="text-sm sm:text-lg text-secondary uppercase tracking-wider">What others say</p>
          <h2 className="text-3xl xs:text-[40px] sm:text-5xl md:text-6xl text-white font-black">Testimonials.</h2>
        </motion.div>
      </div>
